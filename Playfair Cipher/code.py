...
def decryptByPlayfairCipher(Matrix, cipherList):
    ...
    # Remove extra 'x' characters added during encryption
...
def print_matrix(matrix):
    print("Generated Key Square Matrix:")
    for row in matrix:
        print(" ".join(row))
...
print("Decrypted Text without extra characters:", DecryptedText.replace("x", ""))
